...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>AI Bill Audit</span> <span className="text-blue-400/60">✦</span>
    <span>Catch Overcharges</span> <span className="text-emerald-400/60">✦</span>
    <span>Code Validation</span> <span className="text-blue-400/60">✦</span>
    <span>Recover Savings</span> <span className="text-emerald-400/60">✦</span>
    <span>HIPAA Ready</span> <span className="text-blue-400/60">✦</span>
  </div>
)
...
export function CinematicFooter() {
  ...
  return (
    <>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-[#09090b] text-white cinematic-footer-wrapper">
          ...
          <div
            ref={giantTextRef}
            className="cf-giant-bg-text absolute -bottom-[5vh] left-1/2 -translate-x-1/2 whitespace-nowrap z-0 pointer-events-none select-none"
          >
            ACUVERA
          </div>
          ...
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-white/10 bg-black/60 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-2xl">
            <div className="flex w-max cf-marquee text-xs md:text-sm font-bold tracking-[0.3em] text-zinc-400 uppercase">
              <MarqueeItem />
              <MarqueeItem />
            </div>
          </div>
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton
                  as="a"
                  href="#waitlist"
                  className="cf-glass-pill px-10 py-5 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group"
                >
                  Join the Waitlist
                </MagneticButton>
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton
                  as="a"
                  href="/privacy"
                  className="cf-glass-pill px-6 py-3 rounded-full text-zinc-400 font-medium text-xs md:text-sm hover:text-white"
                >
                  Privacy Policy
                </MagneticButton>
                <MagneticButton
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-zinc-400 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Acuvera. All rights reserved.
            </div>
            ...
            <div className="cf-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default">
              ...
              <span className="cf-heartbeat text-sm md:text-base text-red-500">❤</span>
              <span className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">
                by
              </span>
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">
                Acuvera
              </span>
            </div>
            ...
            <MagneticButton
              as="button"
              onClick={scrollToTop}
              className="w-12 h-12 rounded-full cf-glass-pill flex items-center justify-center text-zinc-400 hover:text-white group order-3"
            >
              <svg
